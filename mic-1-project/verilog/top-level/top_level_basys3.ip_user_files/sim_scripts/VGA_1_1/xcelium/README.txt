...
#
# Generated by export_simulation on Wed Jan 25 15:46:59 +0100 2023
#
################################################################################
...
'-reset_run' switch to the './VGA_1.sh' script.
...
./VGA_1.sh -noclean_files

For more information on the script, please type './VGA_1.sh -help'.
