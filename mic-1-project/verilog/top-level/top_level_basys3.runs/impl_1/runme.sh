...
HD_PWD='C:/Users/emile/OneDrive/files/mic-1-project/verilog/top-level/top_level_basys3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mic1_basys3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mic1_basys3.tcl -notrace
