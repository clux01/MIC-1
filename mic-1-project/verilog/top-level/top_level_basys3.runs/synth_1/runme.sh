...
HD_PWD='C:/Users/emile/OneDrive/files/mic-1-project/verilog/top-level/top_level_basys3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mic1_basys3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mic1_basys3.tcl
